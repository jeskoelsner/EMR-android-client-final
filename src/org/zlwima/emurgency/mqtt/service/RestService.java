...
import org.zlwima.emurgency.mqtt.models.Shared.Rest;
...
public class RestService extends IntentService {
		...
		protected void onHandleIntent(Intent intent) {
				...
				try {
						if (command.equals(ACTIVITY_STREAM_COMMAND)) {
								int page = intent.getIntExtra(LAST_TIMESTAMP, 0);
		...
		public static String getNews(int timestamp) throws HttpResponseException {
				String newsUrl = ACTIVITY_STREAM_URL + "/" + APPLICATION.DISPATCHER + "/" + timestamp + "/20";
