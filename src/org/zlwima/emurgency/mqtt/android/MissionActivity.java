...
import org.zlwima.emurgency.mqtt.models.EmrVolunteer;
import org.zlwima.emurgency.mqtt.models.Shared;
...
public class MissionActivity extends FragmentActivity implements View.OnClickListener, UnlockListener, CompoundButton.OnCheckedChangeListener {
		...
		protected void onCreate(Bundle savedInstanceState) {
				...
				directions = mapd.refreshDocument(
						new LatLng(APPLICATION.USER.getCurrentLocation().getLatitude(), APPLICATION.USER.getCurrentLocation().getLongitude()),
		...
		public void updateMarker() {
				...
				selfMarker.position(getLatLng(APPLICATION.USER.getCurrentLocation()));
		...
		public void updateDistance(EmrCaseData caseData) {
				...
				double distance = Shared.calculateDistance(
						...
						APPLICATION.USER.getCurrentLocation().getLatitude(),
						APPLICATION.USER.getCurrentLocation().getLongitude());
				if (distance > 10000) {
